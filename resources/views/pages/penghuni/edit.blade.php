    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('rumah.penghuni.update', [$rumah->id, $penghuni->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('status_penghuni') is-invalid @enderror" 
                                    ...
                                    <option value="pemilik rumah" {{ old('status_penghuni', $penghuni->status_penghuni) == 'pemilik rumah' ? 'selected' : '' }}>Pemilik Rumah</option>
                                    <option value="kontrak" {{ old('status_penghuni', $penghuni->status_penghuni) == 'kontrak' ? 'selected' : '' }}>Kontrak</option>
                                    <option value="boro" {{ old('status_penghuni', $penghuni->status_penghuni) == 'boro' ? 'selected' : '' }}>Boro</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('is_kepala_keluarga') is-invalid @enderror" 
                                    ...
                                    <option value="">Pilih Status</option>
                                    <option value="1" {{ old('is_kepala_keluarga', $penghuni->is_kepala_keluarga) == '1' ? 'selected' : '' }}>Kepala Keluarga</option>
                                    <option value="0" {{ old('is_kepala_keluarga', $penghuni->is_kepala_keluarga) == '0' ? 'selected' : '' }}>Anggota Keluarga</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('agama') is-invalid @enderror" 
                                    ...
                                    <option value="Islam" {{ old('agama', $penghuni->agama) == 'Islam' ? 'selected' : '' }}>Islam</option>
                                    <option value="Kristen" {{ old('agama', $penghuni->agama) == 'Kristen' ? 'selected' : '' }}>Kristen</option>
                                    <option value="Katolik" {{ old('agama', $penghuni->agama) == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                                    <option value="Hindu" {{ old('agama', $penghuni->agama) == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                                    <option value="Buddha" {{ old('agama', $penghuni->agama) == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                                    <option value="Konghucu" {{ old('agama', $penghuni->agama) == 'Konghucu' ? 'selected' : '' }}>Konghucu</option>
                                </select>
                                @error('agama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('no_hp') is-invalid @enderror" 
                                       id="no_hp" name="no_hp" value="{{ old('no_hp', $penghuni->no_hp) }}" required>
                                @error('no_hp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('pendidikan') is-invalid @enderror" 
                                    ...
                                    <option value="Blm/tidak" {{ old('pendidikan', $penghuni->pendidikan) == 'Blm/tidak' ? 'selected' : '' }}>Belum/Tidak Sekolah</option>
                                    <option value="SD" {{ old('pendidikan', $penghuni->pendidikan) == 'SD' ? 'selected' : '' }}>SD</option>
                                    <option value="SMP" {{ old('pendidikan', $penghuni->pendidikan) == 'SMP' ? 'selected' : '' }}>SMP</option>
                                    <option value="SMA" {{ old('pendidikan', $penghuni->pendidikan) == 'SMA' ? 'selected' : '' }}>SMA</option>
                                    <option value="Diploma" {{ old('pendidikan', $penghuni->pendidikan) == 'Diploma' ? 'selected' : '' }}>Diploma</option>
                                    <option value="S1" {{ old('pendidikan', $penghuni->pendidikan) == 'S1' ? 'selected' : '' }}>S1</option>
                                    <option value="S2" {{ old('pendidikan', $penghuni->pendidikan) == 'S2' ? 'selected' : '' }}>S2</option>
                                    <option value="S3" {{ old('pendidikan', $penghuni->pendidikan) == 'S3' ? 'selected' : '' }}>S3</option>
                                </select>
                                @error('pendidikan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('status_martial') is-invalid @enderror" 
                                    ...
                                    <option value="">Pilih Status</option>
                                    <option value="MENIKAH" {{ old('status_martial', $penghuni->status_martial) == 'MENIKAH' ? 'selected' : '' }}>Menikah</option>
                                    <option value="JANDA/DUDA" {{ old('status_martial', $penghuni->status_martial) == 'JANDA/DUDA' ? 'selected' : '' }}>Janda/Duda</option>
                                    <option value="BELUM MENIKAH" {{ old('status_martial', $penghuni->status_martial) == 'BELUM MENIKAH' ? 'selected' : '' }}>Belum Menikah</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('pekerjaan') is-invalid @enderror" 
                                    ...
                                    <option value="swasta" {{ old('pekerjaan', $penghuni->pekerjaan) == 'swasta' ? 'selected' : '' }}>Swasta</option>
                                    <option value="pns" {{ old('pekerjaan', $penghuni->pekerjaan) == 'pns' ? 'selected' : '' }}>PNS</option>
                                    <option value="guru" {{ old('pekerjaan', $penghuni->pekerjaan) == 'guru' ? 'selected' : '' }}>Guru</option>
                                    <option value="dosen" {{ old('pekerjaan', $penghuni->pekerjaan) == 'dosen' ? 'selected' : '' }}>Dosen</option>
                                    <option value="pensiunan" {{ old('pekerjaan', $penghuni->pekerjaan) == 'pensiunan' ? 'selected' : '' }}>Pensiunan</option>
                                    <option value="ibu rumah tangga" {{ old('pekerjaan', $penghuni->pekerjaan) == 'ibu rumah tangga' ? 'selected' : '' }}>Ibu Rumah Tangga</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('tempat_kerja') is-invalid @enderror" 
                                       id="tempat_kerja" name="tempat_kerja" value="{{ old('tempat_kerja', $penghuni->tempat_kerja) }}">
                                @error('tempat_kerja')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <label for="kartu_keluarga" class="form-label">Upload Kartu Keluarga (Opsional)</label>
                            @if($penghuni->kartu_keluarga)
                                <div class="mb-2">
                                    @if(pathinfo($penghuni->kartu_keluarga, PATHINFO_EXTENSION) === 'pdf')
                                        <a href="{{ asset('storage/' . $penghuni->kartu_keluarga) }}" target="_blank" class="btn btn-sm btn-info">Lihat KK (PDF)</a>
                                    @else
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                if (!preview) {
                    ...
                    preview.innerHTML = '<h6>Preview KTP Baru:</h6><img src="" class="img-thumbnail" style="max-width: 300px;">';
            ...
            reader.onload = function(e) {
                ...
                if (!preview) {
                    ...
                    if (file.type.match('image.*')) {
                        preview.innerHTML = '<h6>Preview KK Baru:</h6><img src="" class="img-thumbnail" style="max-width: 300px;">';
                    } else {
