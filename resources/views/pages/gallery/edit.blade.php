            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('gallery.update', $gallery->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="foto_gallery" class="form-label">Foto Tampak Depan gallery</label>
                            
                            @if($gallery->foto_gallery)
                                <div class="mb-2">
                            ...
                            <input type="file" class="form-control @error('foto_gallery') is-invalid @enderror" 
                                   id="foto_gallery" name="foto_gallery" 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('tanggal') is-invalid @enderror" 
                                       ...
                                       value="{{ old('tanggal', $gallery->tanggal) }}" required>
                                @error('tanggal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                    id="deskripsi" name="deskripsi" required>{{ old('deskripsi', $gallery->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
