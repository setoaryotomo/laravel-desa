        ...
        <div class="col-md-16">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Data User Baru</h3>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('role_id') is-invalid @enderror" 
                                    ...
                                    <option value="3" {{ old('role_id') == '3' ? 'selected' : '' }}>RW</option>
                                    <option value="4" {{ old('role_id') == '4' ? 'selected' : '' }}>RT</option>
                                </select>
                                @error('role_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 dynamic-field" id="rw-field">
                            ...
                            <div class="col-md-6 dynamic-field" id="rt-field">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('user.index') }}" class="btn btn-secondary me-md-2 mr-1">Kembali</a>
