    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('rumah.penghuni.store', $rumah->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('status_penghuni') is-invalid @enderror" 
                                    ...
                                    <option value="pemilik rumah" {{ old('status_penghuni') == 'pemilik rumah' ? 'selected' : '' }}>Pemilik Rumah</option>
                                    <option value="kontrak" {{ old('status_penghuni') == 'kontrak' ? 'selected' : '' }}>Kontrak</option>
                                    <option value="boro" {{ old('status_penghuni') == 'boro' ? 'selected' : '' }}>Boro</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('is_kepala_keluarga') is-invalid @enderror" 
                                    ...
                                    <option value="">Pilih Status</option>
                                    <option value="1" {{ old('is_kepala_keluarga') == '1' ? 'selected' : '' }}>Kepala Keluarga</option>
                                    <option value="0" {{ old('is_kepala_keluarga') == '0' ? 'selected' : '' }}>Anggota Keluarga</option>
                                </select>
...
<script>
    ...
    document.getElementById('kartu_keluarga').addEventListener('change', function(event) {
        ...
        if (file && file.type.match('image.*')) {
            const reader = new FileReader();
            reader.onload = function(e) {
                let preview = document.getElementById('kk-preview');
                if (!preview) {
                    preview = document.createElement('div');
